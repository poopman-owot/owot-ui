    ...
    <div class="container">
      ...
      <div class="container-bg">
        <div class="popup-panel">
          ...
          <ul class="icon-list">
            <li class="btn hidden" id="paste-preview-btn"><i class="fas fa-check"></i>Paste Preview<i class="fas fa-toggle-off"></i></li>
  ...
  <div class="header">
    <div class="menu">
      ...
      <div class="menu-content">
        <button id="unload-pm"><i class="fas fa-file"></i> Unload</button>
      </div>
    </div>
...
<label for="default"><i class="fas fa-undo"></i> Default</label>
 ...
 <input id = "url-paste-input" placeholder="Enter URL">
    ...
    <div>
      <button class="header-button" id="wiki-btn"><i class="fas fa-book-open"></i> Wiki</button>
      <button class="header-button" id="user-btn"><i class="fas fa-user"></i></button>
      <div>
      </div>
...
function toggleIconBool(targetElement,val){
  ...
  const toggleOffClass = "fa-toggle-off";
    ...
    else{targetElement.classList.remove(toggleOnClass);
...
w.ui.selectionModal.client.children[0].children[0].click();
    ...
    Swal.fire({title:'copied', backdrop: false, position: 'bottom-end', showConfirmButton: false,timer: 1000, showClass: {
...
if(cursorCoords !== null){
    const {bgColor, char, color,protection} = getCharInfo();
